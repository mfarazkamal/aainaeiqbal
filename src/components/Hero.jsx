      ...
      <section className="flex justify-center items-center px-4 py-2 h-full border-b-2">
        ...
        <div className="w-full text-center px-6">
          ...
          <p className="text-3xl text-[#1f2430] my-4 w-[25vw] mx-auto leading-12">
            اشعار کی تشریح اقبالیات کے ماہرین ،جن میں پروفیسریوسف سلیم چشتی صاحب
            ، عارف بتالوی ،ڈاکٹر خواجہ حمیدیزدانی ، ڈاکٹر سلیم اختر صاحب وغیرہ
            کی کتابوں اور آرا٫ کی روشنی میں کی گئی ہے۔اللہ سے دعا ہے کہ اللہ
            تعالیٰ ہمارے اس کام میں مدد فرمائے اور ہمیں اس کام کو آغاز سے انجام
            تک پہونچانے میں مدد فرمائے۔ آمین
          </p>
