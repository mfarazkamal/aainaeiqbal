    ...
    <div className="bg-[#1a1a1a] py-12 px-4 md:px-10">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        {randomStanzas.map((item, index) => (
          <Link to={`/post/${item.slug}`} key={index} className="block group">
            <div
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col p-6 md:p-12">
                ...
                <div className="flex justify-between items-start gap-4">
                  ...
                  <div className="bg-[#1f1e1e]/80 text-gray-200 px-3 py-1 md:px-4 md:py-2 rounded-lg text-[10px] md:text-sm border border-gray-600 max-w-[50%] truncate">
